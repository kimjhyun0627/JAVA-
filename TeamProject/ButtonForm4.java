...
public class ButtonForm4 extends JButton {
	public ButtonForm4(String imgPath) {
		...
		// ImageIcon imgIconClick = new ImageIcon(imgPath+"_click.png");
		...
		// Image ImgClick = imgIcon.getImage();
		// ImgClick = Img.getScaledInstance(200, 100, Image.SCALE_SMOOTH);

		imgIcon.setImage(Img);
		imgIconDark.setImage(ImgDark);
		// imgIconClick.setImage(ImgClick);
